Shader "Hidden/Locked/.poiyomi/Poiyomi Toon World/718f1030e96c8434f9368a019c548ff1"
{
	Properties
	{
 ...
 #define OPTIMIZER_ENABLED 
			...
			void applyMatcap(inout PoiFragData poiFragData, in PoiCam poiCam, in PoiMesh poiMesh, inout PoiLight poiLight, in PoiMods poiMods)
			{
				...
				blendMatcap(poiLight, poiFragData, poiMods, 0.053, 0.0, 0.567, 0.0, 0.0, 0.0, matcap, matcapMask, 0.0, 0.374, 1.0, 1.0, matcapALD);
				#endif
				#ifdef COLOR_GRADING_HDR_3D
				matcapALD.matcapALEnabled = 0.0;
				matcapALD.matcapALAlphaAddBand = 0.0;
				...
				blendMatcap(poiLight, poiFragData, poiMods, 0.452, 0.0, 0.375, 0.0, 0.0, 0.0, matcap2, matcap2Mask, 0.0, 0.0, 1.0, 2.0, matcapALD);
				#endif
			}
			#endif
